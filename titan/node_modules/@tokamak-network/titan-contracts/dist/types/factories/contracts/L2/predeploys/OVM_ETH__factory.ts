...
import type {
  OVM_ETH,
  OVM_ETHInterface,
} from "../../../../contracts/L2/predeploys/OVM_ETH";
...
type OVM_ETHConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: OVM_ETHConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class OVM_ETH__factory extends ContractFactory {
  constructor(...args: OVM_ETHConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override deploy(
    ...
    return super.deploy(overrides || {}) as Promise<OVM_ETH>;
  }
  ...
  override attach(address: string): OVM_ETH {
    return super.attach(address) as OVM_ETH;
  }
  override connect(signer: Signer): OVM_ETH__factory {
    return super.connect(signer) as OVM_ETH__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): OVM_ETHInterface {
    return new utils.Interface(_abi) as OVM_ETHInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): OVM_ETH {
    return new Contract(address, _abi, signerOrProvider) as OVM_ETH;
  }
}
