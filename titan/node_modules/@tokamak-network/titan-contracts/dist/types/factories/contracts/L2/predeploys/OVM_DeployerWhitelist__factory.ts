...
import type {
  ...
  OVM_DeployerWhitelistInterface,
} from "../../../../contracts/L2/predeploys/OVM_DeployerWhitelist";
...
type OVM_DeployerWhitelistConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: OVM_DeployerWhitelistConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class OVM_DeployerWhitelist__factory extends ContractFactory {
  constructor(...args: OVM_DeployerWhitelistConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): Promise<OVM_DeployerWhitelist> {
    return super.deploy(overrides || {}) as Promise<OVM_DeployerWhitelist>;
  }
  ...
  override attach(address: string): OVM_DeployerWhitelist {
    return super.attach(address) as OVM_DeployerWhitelist;
  }
  override connect(signer: Signer): OVM_DeployerWhitelist__factory {
    return super.connect(signer) as OVM_DeployerWhitelist__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): OVM_DeployerWhitelistInterface {
    return new utils.Interface(_abi) as OVM_DeployerWhitelistInterface;
  }
  static connect(
    address: string,
