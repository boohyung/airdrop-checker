...
export declare namespace IL1CrossDomainMessenger {
  ...
  export type L2ToL1MessageStruct = {
    target: PromiseOrValue<string>;
    sender: PromiseOrValue<string>;
    message: PromiseOrValue<BytesLike>;
    messageNonce: PromiseOrValue<BigNumberish>;
    proof: IL1CrossDomainMessenger.L2MessageInclusionProofStruct;
  };

  export type L2ToL1MessageStructOutput = [
    string,
    string,
    string,
    BigNumber,
    IL1CrossDomainMessenger.L2MessageInclusionProofStructOutput
  ] & {
    target: string;
    sender: string;
    message: string;
    messageNonce: BigNumber;
    proof: IL1CrossDomainMessenger.L2MessageInclusionProofStructOutput;
  };
}

export interface L1CrossDomainMessengerFastInterface extends utils.Interface {
  functions: {
    "allowMessage(bytes32)": FunctionFragment;
    "batchRelayMessages((address,address,bytes,uint256,(bytes32,(uint256,bytes32,uint256,uint256,bytes),(uint256,bytes32[]),bytes,bytes))[])": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [IL1CrossDomainMessenger.L2ToL1MessageStruct[]]
  ): string;
  encodeFunctionData(
...
export interface L1CrossDomainMessengerFast extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1CrossDomainMessengerFastInterface;
  ...
  functions: {
    ...
    batchRelayMessages(
      _messages: IL1CrossDomainMessenger.L2ToL1MessageStruct[],
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
